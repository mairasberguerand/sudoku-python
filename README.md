...
![License](https://img.shields.io/badge/licença-livre%20para%20estudo-lightgrey)

Um jogo de Sudoku em desenvolvido em Python, direto no terminal, criado como projeto pessoal de aprendizado e evolução na programação.
...
-  Controle das jogadas do usuário
-  Menu principal com opções de jogo
-  Níveis de dificuldade
-  Coordenadas no estilo A-I para facilitar a jogada
